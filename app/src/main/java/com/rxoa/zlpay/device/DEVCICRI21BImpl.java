...
public class DEVCICRI21BImpl implements DeviceInterface,CommunicationListener{
	...
	private String dVersion = "BT_ACI21B";
	/*******设备接口操作信息***********/
	@Override
	...
	public void installKeys(String keystr, int keytype) {
		if(keytype==10){
			...
			new Thread(new Runnable(){
				@Override
				public void run() {
					String tmkstr =deviceKeys.substring(40,72);
					tmkstr = "4C5FD19CD4CE8E81A360CCC2530290AF";//1E8AC52C
			...
			new Thread(new Runnable(){
				...
				public void run() {
					...
					if((cmdret!=null)&&(cmdret.Return_Result==0X00)){
						deviceListener.showMessage("工作密钥装载成功～");
