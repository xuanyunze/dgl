...
public class DigitPasswordKeyPad extends View {  
    ...
    private TextView digitkeypad_edittip;
    private DigitPasswordKeyPadListener lisenter;
   ...
   public void setLisenter(DigitPasswordKeyPadListener lisenter){
	   this.lisenter = lisenter;
   }
    @Override  
    protected void onLayout(boolean arg0, int arg1, int arg2, int arg3, int arg4) {  
    }  
   public void setKeyboadTip(String tip){
	   digitkeypad_edittip.setText(tip);
   }
    ...
    public View setup() {  
        ...
        v = lif.inflate(R.layout.acty_keyboard, null);
        ...
        digitkeypad_edittip = (TextView) v.findViewById(R.id.digitpadedittip); 
        // 添加点击事件  
    ...
    private class DigitPasswordKeypadFinshOnClikcListener implements OnClickListener {  
        ...
        public void onClick(View v) {  
            ...
            if (viewId == R.id.digitkeypad_ok) {  
                ...
                lisenter.onInputFinished(digitkeypad_edittext.getText().toString());
            }  
        }  
    }  
