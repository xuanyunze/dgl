...
import com.rxoa.zlpay.combx.wheel.OnWheelChangedListener;
import com.rxoa.zlpay.combx.wheel.WheelView;
import com.rxoa.zlpay.combx.wheel.adapters.ArrayWheelAdapter;
...
public class CitiesActivity extends Activity implements OnWheelChangedListener
{
	...
	public void showChoose(View view)
	{
		...
		intent.putExtra("cities", mCurrentProviceName +"-"+ mCurrentCityName +"-"+ mCurrentAreaName);
